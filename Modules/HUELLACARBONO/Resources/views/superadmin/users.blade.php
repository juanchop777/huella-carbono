    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900 mb-2">
                <i class="fas fa-users text-indigo-600"></i> Gestión de Usuarios
            </h1>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-2">
                                    @php
                                        $hcRoles = $user->roles->where('slug', 'like', 'huellacarbono.%');
                                    @endphp
                            ...
                            <td class="px-6 py-4 text-center">
                                @php
                                        $currentHcRole = $user->roles->where('slug', 'like', 'huellacarbono.%')->first();
                                    @endphp
                                    <button type="button"
                                        class="assign-role-btn text-indigo-600 hover:text-indigo-800 transition"
    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
        ...
        <form id="assignRoleForm">
            ...
            <div class="mb-4">
                ...
                <select name="role_id" id="assign_role_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
