...
Route::middleware(['lang'])->group(function () { //Middleware que permite la internacionalizacion
    ...
    Route::prefix('sigac')->group(function () {  // agrega el prefijo en la url (sicefa.test/sigac/...)
        ...
        Route::controller(ProgrammeController::class)->group(function () {
            ...
            Route::delete('support/programming/program_request/destroy/{id}', 'program_request_destroy')->name('sigac.academic_coordination.programming.program_request.destory'); // Eliminar solicitud del programa (Apoyo)
            Route::delete('academic_coordination/programming/program_request/destroy/{id}', 'program_request_destroy')->name('sigac.support.programming.program_request.destory'); // Eliminar solicitud del programa (Coordinación Académica)
